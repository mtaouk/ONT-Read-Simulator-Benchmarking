...
# tool name -> (paf, fastq)
files = {
     "test": ("/home/taouk/ONT_read_sim/PBSIM3/test18122025/gono_primary.paf", "/home/taouk/ONT_read_sim/PBSIM3/test18122025/gono_reads.fastq.gz")
}
...
combined[output_cols].to_csv("test_stats.tsv", sep="\t", index=False)
print("✅ Combined stats written to test_stats.tsv")
